...
%PYTHON% -m pip install . --no-build-isolation --no-deps -vv -Csetup-args=-Db_vscrt=none -Csetup-args=-Dbuildtype=plain "-Csetup-args=--native-file=%SRC_DIR%\meson_rt.ini"
